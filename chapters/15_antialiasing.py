...
class Renderer:
    def __init__(
            self, scene: Scene, image_width: int, image_height: int,
            aa_samples: float = 1.0, bg_color: Optional[Color] = None
    ) -> None:
        self._scene = scene
        ...
        self._aa_samples = aa_samples
        self._image_width = int(image_width * self._aa_samples)
        self._image_height = int(image_height * self._aa_samples)
